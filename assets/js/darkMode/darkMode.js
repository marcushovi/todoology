...
style.innerText += " .darkMode-btn { background : " + settings.buttonColor + "; z-index :  40;  width : " + settings.buttonWidth + ";  height : " + settings.buttonHeight + ";  border : " + settings.buttonBorder + ";  cursor : pointer;   user-select : none;  font-size : 1em; line-height : " + settings.buttonLineHeight + ";  text-align : center; }";
