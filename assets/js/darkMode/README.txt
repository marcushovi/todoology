...
Hi, darkMode.js is simple solution for web where you want to have dark mode (very simple 😀. But maybe it will be helpfull).
Is written in pure Javascript.

Author: Marek Hovancak alias Marcus Hovi.
Date: 12.3.2020
...
*Calling function*
******************
- function darkModeIsActivated() is executed when you click on darkMode button
- You can create that function if you want something change on web when dark mode is activated or not
- This function is execute if you want activated or deactivated dark mode
- Just paste the following code before the darkMode.js script (create another HTML script tag before the darkMode.js script tag) or (paste it into some existing javascript file)
...
- Just paste the following code before the darkMode.js script (create another HTML script tag before the darkMode.js script tag) or (paste it into some existing javascript file)
- You don't have to enter all the settings, just the ones you want to change
NOTE : !!! Do not save settings in a block of code that runs when the document is ready !!!
...
var settings = {
	...
	buttonBorderRadius       : "50%",					// default '50%'
