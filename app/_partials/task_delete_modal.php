<div id="delete_task_overlay" class="fixed z-50 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
        ...
        <div class="inline-block align-bottom bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                ...
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        <h3 class="text-lg leading-6 font-medium text-gray-100">
                            Delete Task: <span id="task_modal_title" class="font-bold"></span>
                        </h3>
                        <div class="mt-2">
                            <p class="text-sm text-gray-200">
                                Are you sure you want to delete this task? This task will be permanently removed. This
            ...
            <div class="px-4 py-3 sm:px-6 flex ">
                ...
                <button type="button"  class="basis-1/2 tracking-wide relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-m font-bold rounded-lg bg-red-500 text-white hover:text-gray-400 transition-colors focus:ring-4 focus:outline-none focus:ring-blue-800">
                    <span onclick="window.task_delete_close()" class="w-full relative px-5 py-2.5 ">
                        Cancel
                    </span>
                </button>
            </div>
